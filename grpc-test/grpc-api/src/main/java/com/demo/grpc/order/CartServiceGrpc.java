...
public final class CartServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.demo.grpc.order.ProductOrder,
      com.demo.grpc.order.AddCartResponse> getAddToCartMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AddToCart",
      requestType = com.demo.grpc.order.ProductOrder.class,
      responseType = com.demo.grpc.order.AddCartResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.demo.grpc.order.ProductOrder,
      com.demo.grpc.order.AddCartResponse> getAddToCartMethod() {
    io.grpc.MethodDescriptor<com.demo.grpc.order.ProductOrder, com.demo.grpc.order.AddCartResponse> getAddToCartMethod;
      ...
      synchronized (CartServiceGrpc.class) {
        if ((getAddToCartMethod = CartServiceGrpc.getAddToCartMethod) == null) {
          CartServiceGrpc.getAddToCartMethod = getAddToCartMethod =
              io.grpc.MethodDescriptor.<com.demo.grpc.order.ProductOrder, com.demo.grpc.order.AddCartResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.order.AddCartResponse.getDefaultInstance()))
  ...
  public static abstract class CartServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.demo.grpc.order.ProductOrder> addToCart(
        io.grpc.stub.StreamObserver<com.demo.grpc.order.AddCartResponse> responseObserver) {
          ...
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                ...
                com.demo.grpc.order.AddCartResponse>(
