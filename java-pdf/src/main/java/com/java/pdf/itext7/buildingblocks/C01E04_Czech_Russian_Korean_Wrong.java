 ...
 * @author hanson.huang
 * @version V1.0
 * @ClassName C01E04_Czech_Russian_Korean_Wrong
 * @date 2025/7/25 16:04
 **/
public class C01E04_Czech_Russian_Korean_Wrong {

    public static final String DEST = rootPath + "/src/main/resources/results/buildingblocks/chapter01/czech_russian_korean_wrong.pdf";
