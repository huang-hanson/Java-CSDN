 ...
 * @author hanson.huang
 * @version V1.0
 * @ClassName C01E05_Czech_Russian_Korean_Right
 * @date 2025/7/25 16:05
 **/
public class C01E05_Czech_Russian_Korean_Right {

    public static final String DEST = rootPath + "/src/main/resources/results/buildingblocks/chapter01/czech_russian_korean.pdf";
