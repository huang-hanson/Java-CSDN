 ...
 * @author hanson.huang
 * @version V1.0
 * @ClassName C01E02_Text_Paragraph_Cardo
 * @date 2025/7/25 15:27
 **/
public class C01E02_Text_Paragraph_Cardo {

    public static final String DEST = rootPath + "/src/main/resources/results/buildingblocks/chapter01/text_paragraph_cardo.pdf";
