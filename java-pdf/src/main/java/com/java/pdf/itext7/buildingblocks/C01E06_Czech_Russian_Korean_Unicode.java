 ...
 * @author hanson.huang
 * @version V1.0
 * @ClassName C01E06_Czech_Russian_Korean_Unicode
 * @Description TODO
 * @date 2025/7/25 16:14
 **/
public class C01E06_Czech_Russian_Korean_Unicode {
    public static final String DEST = rootPath + "/src/main/resources/results/buildingblocks/chapter01/czech_russian_korean_unicode.pdf";

    public static final String FONT = rootPath + "/src/main/resources/fonts/FreeSans.ttf";
    public static final String HCRBATANG = rootPath + "/src/main/resources/fonts/HANBatang.ttf";
