 ...
 * @author hanson.huang
 * @version V1.0
 * @ClassName C01E03_Text_Paragraph_NoCardo
 * @date 2025/7/25 16:00
 **/
public class C01E03_Text_Paragraph_NoCardo {

    public static final String DEST = rootPath + "/src/main/resources/results/buildingblocks/chapter01/text_paragraph_no_cardo.pdf";

    public static final String REGULAR = rootPath + "/src/main/resources/fonts/Cardo-Regular.ttf";
    public static final String BOLD = rootPath + "/src/main/resources/fonts/Cardo-Bold.ttf";
    public static final String ITALIC = rootPath + "/src/main/resources/fonts/Cardo-Italic.ttf";
