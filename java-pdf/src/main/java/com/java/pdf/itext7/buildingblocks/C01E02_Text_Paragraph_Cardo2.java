 ...
 * @author hanson.huang
 * @version V1.0
 * @ClassName C01E02_Text_Paragraph_Cardo2
 * @date 2025/7/25 15:45
 **/
public class C01E02_Text_Paragraph_Cardo2 {

    public static final String DEST = rootPath + "/src/main/resources/results/buildingblocks/chapter01/text_paragraph_cardo%s.pdf";
